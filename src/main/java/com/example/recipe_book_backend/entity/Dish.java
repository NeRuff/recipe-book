...
public class Dish {
    ...
    private List<DishProduct> components = new ArrayList<>();
    ...
    public List<DishProduct> getComponents() { return components; }
    public void setComponents(List<DishProduct> components) { this.components = components; }
